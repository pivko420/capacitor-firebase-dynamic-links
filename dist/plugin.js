var capacitorFirebaseDynamicLinks = (function (exports, core) {
    ...
    const FirebaseDynamicLinks = core.registerPlugin('CapacitorFirebaseDynamicLinks', {
        web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.CapacitorFirebaseDynamicLinksWeb()),
    });

    class CapacitorFirebaseDynamicLinksWeb extends core.WebPlugin {
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        CapacitorFirebaseDynamicLinksWeb: CapacitorFirebaseDynamicLinksWeb,
        CapacitorFirebaseDynamicLinks: CapacitorFirebaseDynamicLinks
    });
